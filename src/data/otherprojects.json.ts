...
const svggradients: Template = {
    ...
    description:
        ' A free collection of SVG Mesh gradients to use in your design tool or HTML!',
    title: 'SVG Gradients'
};
const quicksetup: Template = {
    url: 'https://www.figma.com/community/plugin/1074647052897925336',
    description:
        ' This amazing plugin lets you create empty pages and dividers, no matter what subscription.',
    title: 'Quick Setup'
};
