...
<div class="h-screen flex flex-col items-center divide-y-8">
	<div class="bg-img w-full h-2/6 px-12 flex flex-col" style={bgImg}>
		<div
			class="outline bg-white bg-opacity-40 h-1/2 my-auto flex items-center w-full justify-between"
		>
	...
	<div class="w-full max-w-5xl h-4/6">
		<slot name="content" />
	</div>
</div>
